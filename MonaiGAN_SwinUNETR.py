...
directory = '/work/users/s/r/sridhark/kaggle_data/data_new'
check_dir = '/work/users/s/r/sridhark/indproj/gan2_checkpoint'
...
print('in average meter, fold reader, checkpoint saver')
...
print('complete save_checkpoint')

# In[32]:


#Setup Dataloader
print('enter dataloader setup')
...
data_dir = directory
json_list = '/work/users/s/r/sridhark/kaggle_data/data_new/brats21_folds.json'
roi = (128, 128, 128)
batch_size = 2
sw_batch_size = 4
fold = 1
...
print('demo image visual complete')
...
print('optim + schedule setup complete')

# In[44]:


#Train and Validation Epoch tracking
...
plt.savefig("UNETR_loss.pdf", format="pdf")
plt.show()
...
#Load Checkpoint and test + perform inference
...
plt.savefig("UNETR_seg.pdf", format="pdf")
plt.show()